...
A2DP = '/home/hieu/code/bt/a2dp.py'

# A list of device IDs that you wish to run it on.
DEV_IDS = ['CC:98:8B:22:A4:D3']
...
def generate_handler(device_id):
    ...
    def cb(*args, **kwargs):
        print("something change to {}".format(device_id))
        print(args)
        if args[0] == 'org.bluez.MediaControl1' or args[0] == 'org.bluez.Device1':
